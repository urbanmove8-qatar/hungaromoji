...
────────────────────────────────────────────
Project Overview:
Hungaromoji is a custom emoji replacement system that maps Unicode emojis
to custom image-based emojis for web use.

────────────────────────────────────────────
Code License:
All JavaScript source code in this project is licensed under the
Apache License, Version 2.0.

You may use, modify, and distribute the code in compliance with the License.
...
────────────────────────────────────────────
Emoji Assets:
• Original emoji artwork and base emoji assets © Penguinmod.com
  Licensed under the MIT License.
• Emoji images remain under their original MIT license.
• Modification and redistribution are permitted under MIT terms,
  provided original credit is retained.

────────────────────────────────────────────
Third-Party Assets & References (NOT covered by Apache/MIT):
The following assets are referenced or used under their own licenses.
These assets are NOT relicensed by this project.

• Book excerpts © Móra Könyvkiadó & feketeistvan.hu — All rights reserved.
• OMSZ logo & STOP sign — Wikimedia Commons — Public domain / rights vary.
...
• Additional assets may be included with their respective licenses.

────────────────────────────────────────────
Important Notice:
Third-party assets retain their original licenses.
This project does NOT grant rights beyond those licenses.
Redistribution of restricted assets may require separate permission.
────────────────────────────────────────────
*/
